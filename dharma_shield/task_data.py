    ...
    "upi-scam-triage": {
        ...
        "items": [
            ...
            },
            {
                ...
                "text": "Payment from SBI-Official-Care@okicici: Rs 0.01 test credit. Please confirm receipt to complete KYC verification for Rs 49,999 prize.",
                "english_summary": "Adversarial: perfect grammar, real IFSC format, staged micro-credit to large fraud.",
                "content_type": "text",
                "sgi_flag": False,
                "upi_pattern_detected": True,
                "toxicity_score": 0.05,
            ...
            },
            {
                ...
                "text": "Google Pay festive cashback: Scan the QR below for instant Rs 250 credited to your linked bank - valid till midnight.",
